...
<nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        ...
        <div>
            ...
            <p class="navbar-text navbar-right">欢迎:${sessionScope.admin}</p>
        </div>
    </div>
</nav>
<div class="container-fluid">
            ...
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav">
                                <li><a href="javascript:$('#content-layout').load('./user.jsp')">用户管理</a></li>
                                <li><a href="javascript:$('#content-layout').load('./echarts.jsp')">用户活跃度分析</a></li>
                                <li><a href="javascript:$('#content-layout').load('./map.jsp')">用户地区分布</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-success">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav">
                                <li><a href="javascript:$('#content-layout').load('./guru.jsp')">上师管理</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="panel panel-info">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav">
                                <li><a href="javascript:$('#content-layout').load('./article.jsp')">文章管理</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="panel panel-warning">
                    ...
                    <div id="collapseFour" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav">
                                <li><a href="javascript:$('#content-layout').load('./album.jsp')">专辑管理</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="panel panel-danger">
                    ...
                    <div id="collapseFive" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav">
                                <li><a href="javascript:$('#content-layout').load('./banner.jsp')">轮播图管理</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseSix" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav">
                                <li><a href="javascript:$('#content-layout').load('./log.jsp')">日志管理</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="myModal1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" style="width: 683px;">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel1">文章信息</h4>
            </div>
            <div class="modal-body">
                <form role="form" id="kindForm1">
                    <div class="form-group">
                        <label for="inputfile">封面</label>
                        <!-- name不能起名和实体类一致 会出现使用String类型接受二进制文件的情况 -->
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <button type="button" class="btn btn-primary" onclick="sub1()">提交更改</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
